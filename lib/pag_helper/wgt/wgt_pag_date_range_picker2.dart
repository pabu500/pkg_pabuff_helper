...
class WgtPagDateRangePicker2 extends StatefulWidget {
  const WgtPagDateRangePicker2({
    super.key,
...
class _WgtPagDateRangePicker2State extends State<WgtPagDateRangePicker2> {
  ...
  Widget build(BuildContext context) {
    ...
    return widget.layout == 'horizontal'
        ? getHorizontalLayout(fromText, toText)
        : getVirticalLayout(fromText, toText);
  }
  ...
  Widget getVirticalLayout(String fromText, String toText) {
    return SizedBox(
      width: 120,
      child: Column(
        mainAxisSize: MainAxisSize.min,
