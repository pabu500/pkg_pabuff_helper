...
class WgtPagHistoryRepChart extends StatefulWidget {
  const WgtPagHistoryRepChart({
    super.key,
  ...
  @override
  State<WgtPagHistoryRepChart> createState() => _WgtPagHistoryRepChartState();
}

class _WgtPagHistoryRepChartState extends State<WgtPagHistoryRepChart> {
