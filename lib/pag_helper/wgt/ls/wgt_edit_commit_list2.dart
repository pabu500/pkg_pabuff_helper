...
class WgtPagEditCommitList2 extends StatefulWidget {
  ...
  final Function? regRefresh;

  @override
  State<WgtPagEditCommitList2> createState() => _WgtPagEditCommitList2State();
}

class _WgtPagEditCommitList2State extends State<WgtPagEditCommitList2> {
  final double _indexWidth = 34;

  late final BoxDecoration listTileDecor = BoxDecoration(
    border: Border(
  ...
  Map<int, Function> _refreshTiles = {};

  void _regItemRefresh(int index, void Function() refresh) {
    _refreshTiles[index] = refresh;
  }

  void _refresh(
    List<Map<String, dynamic>> refreshIndexes, {
    Function? getColor,
  }) {}
  ...
  void initState() {
    ...
    widget.regRefresh?.call(_refresh);
  ...
  Widget build(BuildContext context) {
    ...
    _width = widget.width ?? _getListWidth();
  ...
  Widget _buildListItem(
    ...
    return WgtPagListTile(
      index: index,
      tileWidgetList: listItem,
      decor: listTileDecor,
      regFresh: _regItemRefresh,
    );
  }
  ...
  Widget getCellText({
    ...
    return SizedBox(
      ...
      child: Padding(
        ...
        child: Align(
          alignment: alignment,
          child: SelectableText.rich(TextSpan(text: displayText, style: style)),
        ),
      ),
    );
  }
