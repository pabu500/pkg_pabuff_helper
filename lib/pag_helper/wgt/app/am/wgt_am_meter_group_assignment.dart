...
class WgtAmMeterGroupAssignment extends StatefulWidget {
  const WgtAmMeterGroupAssignment({
    super.key,
  ...
  @override
  State<WgtAmMeterGroupAssignment> createState() =>
      _WgtAmMeterGroupAssignmentState();
}

class _WgtAmMeterGroupAssignmentState extends State<WgtAmMeterGroupAssignment> {
