...
class WgtCreatePagSingularBill2 extends StatefulWidget {
  const WgtCreatePagSingularBill2({
    super.key,
  ...
  @override
  State<WgtCreatePagSingularBill2> createState() =>
      _WgtCreatePagSingularBill2State();
}

class _WgtCreatePagSingularBill2State extends State<WgtCreatePagSingularBill2> {
  String _errorText = '';
  ...
  int get _manualUsageCount => [
        _manualUsageE,
        _manualUsageW,
        _manualUsageB,
        _manualUsageN,
        _manualUsageG,
      ].where((usage) => usage != null).length;

  bool get _singleManualUsageIsValid {
    if (_manualUsageCount != 1) {
      return false;
    }
    if (_manualUsageE != null && _manualUsageErrorTextE != null) return false;
    if (_manualUsageW != null && _manualUsageErrorTextW != null) return false;
    if (_manualUsageB != null && _manualUsageErrorTextB != null) return false;
    if (_manualUsageN != null && _manualUsageErrorTextN != null) return false;
    if (_manualUsageG != null && _manualUsageErrorTextG != null) return false;
    return true;
  }

  void _checkGen3ManualUsage() {
    if (_useAutoUsage) {
      return;
    }
    _checkUsageOK();
  ...
  void _checkUsageOK() {
    ...
    _usageOK = _singleManualUsageIsValid;
    _checkUsageCostOK();
  }
          ...
          Column(
            children: [
              ...
              Padding(
                ...
                child: Text(
                  _manualUsageCount > 1
                      ? 'Manual usage must contain only one meter type'
                      : 'Enter manual usage for one meter type only',
                  style: TextStyle(
                    color: _manualUsageCount > 1
