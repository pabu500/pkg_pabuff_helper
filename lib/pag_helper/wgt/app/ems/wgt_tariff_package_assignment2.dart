...
class WgtTariffPackageAssignment2 extends StatefulWidget {
  const WgtTariffPackageAssignment2({
    super.key,
  ...
  @override
  State<WgtTariffPackageAssignment2> createState() =>
      _WgtTariffPackageAssignment2State();
}

class _WgtTariffPackageAssignment2State
    extends State<WgtTariffPackageAssignment2> {
