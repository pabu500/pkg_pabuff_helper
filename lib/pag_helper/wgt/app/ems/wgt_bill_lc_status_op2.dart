...
class WgtPagBillLcStatusOp2 extends StatefulWidget {
  const WgtPagBillLcStatusOp2({
    super.key,
  ...
  @override
  State<WgtPagBillLcStatusOp2> createState() => _WgtPagBillLcStatusOp2State();
}

class _WgtPagBillLcStatusOp2State extends State<WgtPagBillLcStatusOp2> {
  ...
  Future<void> _commit() async {
    ...
    try {
      ...
      final result = await updateBillLcStatus2(
          widget.appConfig,
          queryMap,
          MdlPagSvcClaim(
            scope: '',
