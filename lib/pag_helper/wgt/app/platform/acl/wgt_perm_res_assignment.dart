...
class WgtPermResAssignment extends StatefulWidget {
  const WgtPermResAssignment({
    super.key,
  ...
  @override
  State<WgtPermResAssignment> createState() => _WgtPermResAssignmentState();
}

class _WgtPermResAssignmentState extends State<WgtPermResAssignment> {
  ...
  Future<void> _doAutoPopulate() async {
    ...
    try {
      final result = await ex(
        endpoint: PagUrlBase.eptGetPermScopeResList,
        crudType: 'read',
  ...
  Future<void> _doCommit() async {
    ...
    try {
      ...
      final result = await ex(
        endpoint: PagUrlBase.eptUpdatePermResList,
        crudType: 'update',
