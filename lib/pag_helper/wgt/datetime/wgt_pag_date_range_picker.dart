...
class WgtPagDateRangePicker extends StatefulWidget {
  const WgtPagDateRangePicker({
    super.key,
  ...
  @override
  State<WgtPagDateRangePicker> createState() => _WgtPagDateRangePickerState();
}

//boilerplate code only
class _WgtPagDateRangePickerState extends State<WgtPagDateRangePicker> {
