...
Future<dynamic> doCreatePagTariffPackage(
  ...
  svcClaim.endpoint = PagUrlBase.eptPagCreateTariffPackage;
  ...
  try {
    ...
    if (response.statusCode == 201) {
      ...
      throw Exception(responseBody['error']['message'] ??
          'Failed to create tariff package');
    }
  } catch (err) {
    throw Exception(err);
  }
...
Future<dynamic> commitTariffPackageTenantList(
  MdlPagAppConfig appConfig,
  Map<String, dynamic> queryMap,
  MdlPagSvcClaim svcClaim,
) async {
