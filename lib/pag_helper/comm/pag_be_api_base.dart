...
class PagUrlBase {
  ...
  static const String eptGetListInfoList2 = '/list/get_list_info_list2';
  ...
  static const String eptGetAclScopeResList2 = '/acl/perm/get_scope_res_list2';
  static const String eptCreateAclPermission2 = '/acl/perm/create_permission2';
  ...
  static const String eptPagGetTenantOffbInfo =
      '/ems/tenant/get_tenant_offb_info';
  static const String eptPagUpdateTenantOffbInfo =
      '/ems/tenant/update_tenant_offb_info';
  ...
  static const String eptUpdateBciTenantAssignment =
      '/ems/billing_cost_item/update_bci_tenant_assignment';
  ...
  static const String eptCheckTpRateInfo = '/ems/billing/check_tp_rate_info';
  ...
  static const String eptAmCommsUpdateDeviceLinkage =
      '/am/comms/update_device_linkage';
