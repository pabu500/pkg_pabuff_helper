...
Future<dynamic> getUsageFactor2(MdlPagAppConfig appConfig,
...
Future<dynamic> getBill2(MdlPagAppConfig appConfig,
    Map<String, String> queryMap, MdlPagSvcClaim svcClaim) async {
  svcClaim.svcName = PagSvcType.oresvc2.name;
...
Future<dynamic> genPagBill2(MdlPagAppConfig appConfig,
...
Future<dynamic> checkPagTpInfo2(MdlPagAppConfig appConfig,
    Map<String, String> queryMap, MdlPagSvcClaim svcClaim) async {
  svcClaim.svcName = PagSvcType.oresvc2.name;
...
Future<dynamic> doGetReleaseCandidate2(MdlPagAppConfig appConfig,
...
Future<dynamic> doBatchOpBill2(MdlPagAppConfig appConfig,
    Map<String, dynamic> reqMap, MdlPagSvcClaim svcClaim) async {
  svcClaim.svcName = PagSvcType.oresvc2.name;
...
Future<dynamic> doBlast2(MdlPagAppConfig appConfig, Map<String, dynamic> reqMap,
