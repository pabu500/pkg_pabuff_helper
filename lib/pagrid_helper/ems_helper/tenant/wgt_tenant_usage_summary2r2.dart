...
class WgtTenantUsageSummary2R2 extends StatefulWidget {
  const WgtTenantUsageSummary2R2({
    super.key,
  ...
  @override
  State<WgtTenantUsageSummary2R2> createState() =>
      _WgtTenantUsageSummary2R2State();
}

class _WgtTenantUsageSummary2R2State extends State<WgtTenantUsageSummary2R2> {
