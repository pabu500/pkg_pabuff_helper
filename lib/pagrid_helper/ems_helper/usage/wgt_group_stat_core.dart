...
class WgtMeterGroupStatCore extends StatefulWidget {
  ...
  @override
  State<WgtMeterGroupStatCore> createState() => _WgtMeterGroupStatCoreState();
}

class _WgtMeterGroupStatCoreState extends State<WgtMeterGroupStatCore> {
  ...
  Future<void> _getMeterUsageSummary() async {
    ...
    try {
      ...
      Map<String, String> queryMap = {
        'project_scope': widget.scopeProfile.selectedProjectScope!.name,
        ...
        'end_datetime': widget.endDateTime == null
            ? getLocalDatetimeNowStr(widget.scopeProfile.timezone)
