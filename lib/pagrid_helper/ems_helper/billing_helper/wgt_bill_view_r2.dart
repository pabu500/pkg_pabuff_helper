...
class WgtBillViewR2 extends StatefulWidget {
  ...
  @override
  State<WgtBillViewR2> createState() => _WgtBillViewR2State();
}

class _WgtBillViewR2State extends State<WgtBillViewR2> {
  ...
  Widget getReleaseRender(
    ...
    return _renderMode == 'pdf'
        ...
        : WgtTenantUsageSummaryReleased2R2(
            costDecimals: widget.costDecimals,
            appConfig: widget.appConfig,
            loggedInUser: widget.loggedInUser,
            scopeProfile: widget.scopeProfile,
