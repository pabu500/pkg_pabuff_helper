                                ...
                                child: InkWell(
                                    ...
                                    onTap: () async {
                                      ...
                                      try {
                                        ...
                                        String? validated = widget.validator
                                        ...
                                        if (hasError) {
                                          setState(() {
                                            ...
                                            if (_errorText.isNotEmpty) {
                                              _errorText =
                                                  _errorText.replaceAll(
                                                      'Exception: ', '');
                                              if (_errorText.contains('OQG')) {
                                                if (_errorText.contains(
                                                    'duplicate key')) {
                                                  _errorText =
                                                      'Duplicated value';
                                                } else {
